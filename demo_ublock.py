...
from openwpm.commands.ublock_commands import (
    AddonSetupCommand,
    AddonCheckAndUUIDCommand,
...
with TaskManager(
    ...
    command_sequence.append_command(AddonSetupCommand())
    ...
    for index, site in enumerate(sites):
        ...
        # load the filter list you want
        command_sequence.append_command(
            FilterListLoadCommand(
                path=str(
                    Path("./openwpm/commands/assets/sample_filterlist.txt").absolute()
                )
            )
        )
